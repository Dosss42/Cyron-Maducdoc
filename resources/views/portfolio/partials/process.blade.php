<section id="process" class="scroll-mt-20 border-b border-line bg-paper-soft">
    <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <p class="section-label">Process</p>
        <h2 class="mt-3 text-3xl font-semibold tracking-tight text-ink">How I Build</h2>
        ...
        <ol class="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5">
            @foreach (config('portfolio.process') as $item)
                <li class="card p-5">
                    ...
                    <h3 class="mt-2 text-sm font-semibold text-ink">{{ $item['step'] }}</h3>
