<section id="education" class="reveal scroll-mt-20 border-b border-line bg-paper-soft">
    <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <p class="section-label">Education</p>
        <h2 class="text-h1 mt-3 text-ink">Education</h2>

        @foreach (config('portfolio.education') as $entry)
            <div class="card mt-8 p-6 sm:p-8">
                <div class="flex flex-col justify-between gap-2 sm:flex-row sm:items-start">
                    <div>
                        <h3 class="text-h3 text-ink">{{ $entry['degree'] }}</h3>
